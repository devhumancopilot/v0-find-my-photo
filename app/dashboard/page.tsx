...
import { Sparkles, Plus, ImageIcon, Clock, Heart, Settings, LogOut, User, FolderOpen } from "lucide-react"

const stats = [
  { label: "Total Albums", value: "12", icon: FolderOpen },
  { label: "Total Photos", value: "1,247", icon: ImageIcon },
        ...
        <div className="mb-8">
          <Card className="border-white/20 bg-gradient-to-r from-blue-500 to-purple-600 text-white">
            <CardContent className="flex items-center justify-between p-6">
              <div>
                <h3 className="mb-1 text-xl font-semibold">Ready to create a new album?</h3>
