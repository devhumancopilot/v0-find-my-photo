        ...
        <Card className="border-white/20 bg-white/80 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" disabled={isLoading} onClick={handleGoogleSignIn} type="button">
              ...
              <Button variant="outline" disabled={isLoading} onClick={handleAppleSignIn} type="button">
